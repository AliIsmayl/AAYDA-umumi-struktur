...
export default function ZoneBackgrounds({ visible }) {
  ...
  return (
    <g className="zone-backgrounds">
      {/* MEIS zone */}
      <rect x="14" y="12" width="175" height="56" rx="14"
        fill="#EEEAFF" stroke="#7C6EF5" strokeWidth="1.2" strokeDasharray="5,4" />

      {/* Tech platform zone */}
      <rect x="14" y="70" width="175" height="412" rx="14"
        fill="#EEF9F4" stroke="#16A97A" strokeWidth="1" strokeDasharray="5,4" />
      <text x="101" y="82" textAnchor="middle" fontSize="10"
      ...
      <text x="290" y="25" textAnchor="middle" fontSize="10"
      ...
      <text x="479" y="25" textAnchor="middle" fontSize="10"
      ...
      <text x="796" y="25" textAnchor="middle" fontSize="10"
      ...
      <text x="1156" y="25" textAnchor="middle" fontSize="10"
